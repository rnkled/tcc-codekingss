...
const Appointment: React.FC = () => {
      ...
      icon: () => (
        <View
          style={{
            ...
            height: 18,
            borderRadius: 4,
            backgroundColor: theme.appoimentColor1,
          }}
        />
      ),
    },
      ...
      icon: () => (
        <View
          style={{
            ...
            height: 18,
            borderRadius: 4,
            backgroundColor: theme.appoimentColor2,
          }}
        />
      ),
    },
      ...
      icon: () => (
        <View
          style={{
            ...
            height: 18,
            borderRadius: 4,
            backgroundColor: theme.appoimentColor3,
          }}
        />
      ),
    },
      ...
      icon: () => (
        <View
          style={{
            ...
            height: 18,
            borderRadius: 4,
            backgroundColor: theme.appoimentColor4,
          }}
        />
      ),
    },
  ...
  useEffect(() => {
    async function getUserData() {
      setLoadingUser(true);
      api
        .get(`/user/list/${routeItem.user_id}`)
        .then((response) => {
  ...
  function check(label, value) {
    if (value == "" || value == undefined || value == null) {
      Alert.alert(
        "Atenção!",
        `Por favor, preencha o campo ${label} para finalizar o processo!`
      );
      return false;
    }
  }
  ...
  function handleUpdate() {
    ...
    api
      .put(`/appointment/update/${professionalID}`, data)
      .then((response) => {
        setLoadingSave(false);
        ...
        <View style={styles.contentPrimary}>
          ...
          <View style={styles.frame}>
            ...
            {loadingUser ? (
              ...
              <SearchCardLite
                ...
                marginTop={10}
                type_user={"user"}
                altFunction={() => setShowSearch(true)}
              />
            ) : (
              <TouchableOpacity
                style={styles.addPacienteBox}
          ...
          <View style={styles.frame}>
            ...
            <DropDownPicker
              ...
              labelProps={{
                style: {
                  color: color ? theme.textVariant : theme.primaryVariant,
                  marginLeft: 9,
                  fontSize: 18,
                },
              }}
