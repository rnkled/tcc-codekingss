...
const FirstTimeProfessional: React.FC = () => {
    ...
    const [addressNumber, setAddressNumber] = useState<string>(String(user.address.number ? user.address.number : ""));
        ...
        <Background>
            <KeyboardAwareScrollView nestedScrollEnabled={true} contentContainerStyle={{alignItems: "center"}}>
                ...
                <View style={styles.contentSecondary}>
                    ...
                    <Button label="Salvar" onPress={handleSave} loading={loadingSave} containerStyle={{marginVertical: 30}}/>
                </View>
